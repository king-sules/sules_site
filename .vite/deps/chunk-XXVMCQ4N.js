...
function createGrid(options = {}) {
  ...
  const Grid2 = React12.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime5.jsx)(GridRoot, {
      ref,
      as: component,
      ownerState,
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React24.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React24.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React24.useMemo(() => storageManager?.({
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime12.jsxs)(React25.Fragment, {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XXVMCQ4N.js.map
